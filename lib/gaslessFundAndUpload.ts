...
async function gaslessFundAndUploadString(data: string, tags: Tag[]): Promise<string>{
    return await gaslessFundAndUploadData(data, tags);
}
/**
 * Uploads a string and tags after funding if necessary.
 *
 * @param {data} string - The string content such as urls, text
...
export { gaslessFundAndUpload, gaslessFundAndUploadString};
